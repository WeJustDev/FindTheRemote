Shader "Water/Ocean_02" {
    Properties {
        ...
        _Noiselevel ("Noise level", Range(0, 0.12)) = 0.12
        [Space(10)]
        [Space(10)]
        _FoamOpacity ("Foam Opacity", Range(0, 2)) = 2
        _FoamLevel ("Foam Level", Float ) = 3
        _FoamLevelDestination ("Foam Level Destination", Float ) = 4
        _FoamPower ("Foam Power", Range(0, 1)) = 0.3944446
        [Space(10)]
        [Space(10)]
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _FoamLevelDestination;
...
////// Emissive:
                ...
                float2 node_7411 = (node_9870+node_4728.g*float2(0,0.05));
                float4 _MainTexture_var = tex2D(_MainTexture,TRANSFORM_TEX(node_7411, _MainTexture));
                float2 node_5898 = (node_9870+node_4728.g*float2(0,0.01));
